...
from theproject.core.views import core
from theproject.users.views import users
from theproject.blog_posts.views import blog_posts
from theproject.error_pages.handlers import error_pages
